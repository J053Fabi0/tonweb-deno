import { crc16, hexToBytes, bytesToHex, stringToBytes, base64toString, stringToBase64 } from "./Utils.ts";
  ...
  toString(isUserFriendly?: boolean, isUrlSafe?: boolean, isBounceable?: boolean, isTestOnly?: boolean): string {
    ...
    if (!isUserFriendly) {
      ...
      let addressBase64 = stringToBase64(
        String.fromCharCode.apply(null, Array.from(new Uint8Array(addressWithChecksum)))
      );
